...
async function administration() { if (currentUser?.role !== 'owner') return overview(); layout('Administracao', `<div class="page-actions"><p class="muted">Crie empresas e gerencie os acessos ao sistema.</p></div><div class="admin-cards"><div class="form-card"><div class="card-title"><div><h3>Criar empresa</h3><p>Prepare um novo dashboard para uma conta.</p></div><span class="step">01</span></div><form id="company-form"><label>Nome da empresa<input name="name" required placeholder="Ex: Atelie da Marina"></label><button type="submit" class="primary full">Criar empresa</button></form></div><div class="form-card"><div class="card-title"><div><h3>Criar usuario</h3><p>Vincule o acesso a uma empresa existente.</p></div><span class="step">02</span></div><form id="user-form"><label>Nome completo<input name="name" required placeholder="Ex: Marina Costa"></label><label>Usuario<input name="user" required placeholder="Ex: marina"></label><label>Email<input name="email" type="email" required placeholder="marina@empresa.com"></label><label>Permissao<select name="role"><option value="user">Usuario</option><option value="owner">Administrador</option></select></label><label>Empresa existente<select name="companyId" id="company-id" required><option value="">Carregando empresas...</option></select></label><label>Senha<div class="generated-password"><input name="password" type="text" minlength="8" required><button type="button" class="icon-button" id="generate-password" title="Gerar senha" aria-label="Gerar senha">↻</button></div></label><button type="submit" class="primary full">Criar usuario</button></form></div></div><div class="list-card admin-user-list"><div class="card-title"><div><h3>Usuarios cadastrados</h3><p>A senha nunca aparece nesta lista.</p></div></div><div id="users-list"><div class="empty"><strong>Carregando usuarios...</strong></div></div></div>`, 'Controle de acesso')
